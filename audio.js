  ...
  files.forEach(item => {
    ...
    if (fileInfo.size / (1024 * 1024) < 20) {    // less than 20MB
      ...
      result.push({
        name: songName,
        artist: arr[2],
        source: 'https://cdn.jsdelivr.net/gh/urzone/jingfei' + item.slice(1),
        url: 'https://cdn.jsdelivr.net/gh/urzone/jingfei' + item.slice(1),
      ...
      result.push({
        name: songName,
        artist: arr[2],
        source: `https://raw.githubusercontent.com/urzone/jingfei/main${item.slice(1)}`,
